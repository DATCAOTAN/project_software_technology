...
#contentQ{
	...
	font-size: 20px;
        ...
        /* CSS cho container chứa danh sách giảng viên */
.gv-container {
    width: 100%;
    padding: 20px;
}

/* CSS cho mỗi item giảng viên */
.gv-item {
...
<section class="mainContent" id="Mainpages">
    <div class="">
        <div class="cauhoi-header">
            <div class="search-container">
                <input type="text" id="searchInput" name="keyword" placeholder="Tìm kiếm Giảng viên...">
                <button type="button" id="searchbtn">Tìm kiếm</button>
            </div>
            <div class="chucnang">
                
                <!-- <button id="createsub" class="button"> Tạo Giảng viên</button> -->
                <button id="editsub" class="button"> Phân Môn cho Giảng viên </button>
                <!-- <div method="post" action="SubController/remove"> 
                    <input type="hidden" name="subjectIdToDelete" id="idremove" value="" > 
                    <button style="height: 50px;" type="submit" id="removesub" name="deleteSubject" class="button">Xóa Giảng viên</button>
                </div> -->
            </div>
        ...
        <div class="cross">
            ...
            <div>
                ...
                <div id="dataQ">
                    ...
                    if (!empty($data["AllQlyGV"])) {
                        foreach ($data["AllQlyGV"] as $row) {
                            $html .= '<div class="dong">';
                        ...
                        // Nếu không có kết quả, hiển thị thông báo "chưa có Giảng viên nào"
                        $html .= '<tr><td colspan="4">Chưa có Giảng viên nào</td></tr>';
                    }
    ...
    <div class="Sticket" id="edit">
        <div class="modal-content">
            ...
            <form method="post" action="QlyGVController/confirm" id="infor">
...
<script>
    ...
    var showEdit = function() {
        ...
        if (select.textContent.trim() === "") alert(" chọn Giảng Viên để phân môn ");
        else {
            loadpanelPhanmon();
            modal = document.querySelector("#edit");
            modal.style.display = "block"
    ...
    var loadpanelPhanmon = function() {
        ...
        xhttp.open("GET", "QlyGVController/loadinfor/" + searchValue, true);
        xhttp.send();
    }
    ...
    var searchGV = function() {
        ...
        let url = `./QlyGVController/search/${searchValue}`;
    ...
    var reload = function() {
        // window.location.href = "http://localhost/Project_web2/web/QlyGVController";
    }
